...
const NotificationCard: React.FC<Notification> = ({ id, title, description, date, image, isNew }) => (
  <div className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow mb-2">
    <div className="flex items-center">
      <span className="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-1 rounded mr-2">{isNew ? 'Mới' : ''}</span>
